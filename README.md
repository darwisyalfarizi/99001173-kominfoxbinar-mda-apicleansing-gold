# How to install 
 ...
 1. install all library from `requirements.txt` in your venv
 2. then init database `python database.py`
 3. then run server `flask run` or `python app.py`
 4. for api in `/docs`
 5. for web in `/`



- for sample data before cleansing in folder uploads
- for sample data after cleansing in folder downloads
